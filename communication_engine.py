...
class CommunicationHub:
    ...
    def whatsapp_offer(self, customer_name: str, city: str, grade: str,
        ...
        return (
            ...
            f"\U0001F3E2 {customer_name} | {city}\n"
            f"\n"
            f"\U0001F3D7\ufe0f Grade: *{grade}*\n"
            f"\U0001F4E6 Qty: *{quantity_mt:.0f} MT*\n"
            f"\U0001F4B0 Rate: *{_fmt_inr(price_per_mt)}/MT* (Landed {city})\n"
            f"{benefit_line}"
            f"\n"
            f"\U0001F69A Dispatch: Within 48 hours\n"
            f"\u23f3 Validity: {self.validity_hours} hours only\n"
            f"\U0001F4B3 Payment: {self.payment_terms}\n"
            f"\n"
    ...
    def whatsapp_reactivation(self, customer_name: str, city: str,
        ...
        return (
            ...
            f"\U0001F4B0 *You save {_fmt_inr(savings)}/MT*\n\n"
