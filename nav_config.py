...
MODULE_NAV: dict[str, dict] = {
    "📊 Price & Info": {
        ...
        "tabs": [
            ...
            {"label": "News", "page": "📰 News Intelligence"},
    ...
    "🧾 Sales": {
        "icon": "🧾", "label": "Sales",
        "tabs": [
            {"label": "One-Click Quote", "page": "💎 One-Click Quote", "star": True},
    ...
    "🚚 Logistics": {
        ...
        "tabs": [
            {"label": "Maritime Intel", "page": "🚢 Maritime Logistics", "star": True},
    ...
    "📤 Sharing": {
        "icon": "📤", "label": "Sharing",
        "tabs": [
            {"label": "Share Center", "page": "📤 Share Center", "star": True},
            {"label": "Telegram", "page": "✈️ Telegram Dashboard"},
            {"label": "Rate Broadcast", "page": "📡 Rate Broadcast", "star": True},
