...
def _get_live_rates():
    try:
        ...
        return {
            ...
            "VG10 Bulk (Mumbai)": lp.get("DRUM_MUMBAI_VG10", 75910) - 2000,
            "VG10 Drum (Mumbai)": lp.get("DRUM_MUMBAI_VG10", 75910),
        }
    except Exception:
        return {"VG30 Bulk": 74870, "VG30 Drum": 76870, "VG10 Bulk": 73910, "VG10 Drum": 75910}
