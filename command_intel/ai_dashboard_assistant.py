...
""")
    ...
    faq_examples = [
        ("What is current VG-30 price at IOCL Koyali?",              "HIGH",   "₹78,260/MT basic (ex-Koyali). Source: price_master.py (single source of truth)"),
        ("Which refinery has the cheapest VG-30 today?",              "HIGH",   "CPCL Chennai at ₹74,582/MT. Source: price_master.py"),
        ("Calculate landed cost from IOCL Koyali to Pune, 900 km.",  "HIGH",   "₹78,260 + (900 × ₹5.5/km) = ₹83,210/MT. Formula shown."),
        ...
        ("What is next PSU revision date?",                           "HIGH",   "1st & 16th of each month (fortnightly PSU revision cycle)."),
        ...
        ("Convert ₹78,260/MT to USD/MT.",                             "HIGH",   "₹78,260 ÷ 86.19 = $907.99/MT. Formula shown."),
